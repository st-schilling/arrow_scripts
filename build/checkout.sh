...
export CHECKOUT_REFERENCE="refs/tags/11.0.0_r76"
...
git clone -b arrow-11.0 --single-branch --depth 1 https://github.com/st-schilling/android_kernel_motorola_sanders.git  -b $CHECKOUT_REFERENCE kernel/motorola/msm8953
